...
.method private declared-synchronized cq()V
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/s;->sH:Lcom/google/android/gms/analytics/f;

    invoke-interface {v1}, Lcom/google/android/gms/analytics/f;->bZ()Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    :cond_1
    :try_start_1
    iget-boolean v1, p0, Lcom/google/android/gms/analytics/s;->td:Z
    ...
    :cond_2
    sget-object v1, Lcom/google/android/gms/analytics/s$3;->tj:[I

    iget-object v2, p0, Lcom/google/android/gms/analytics/s;->sU:Lcom/google/android/gms/analytics/s$a;
    ...
    :goto_1
    :pswitch_1
    iget-object v1, p0, Lcom/google/android/gms/analytics/s;->sY:Ljava/util/Queue;
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/s;->sG:Lcom/google/android/gms/analytics/d;

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/s$d;->cv()Ljava/util/Map;

    move-result-object v2

    invoke-virtual {v6}, Lcom/google/android/gms/analytics/s$d;->cw()J
    ...
    invoke-virtual {v6}, Lcom/google/android/gms/analytics/s$d;->cx()Ljava/util/List;
    ...
    :cond_3
    :try_start_2
    iget-boolean v1, p0, Lcom/google/android/gms/analytics/s;->sJ:Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/s;->sX:Lcom/google/android/gms/analytics/GoogleAnalytics;
    ...
    iget-object v1, p0, Lcom/google/android/gms/analytics/s;->sV:Lcom/google/android/gms/analytics/b;
    ...
    :cond_5
    iget-object v1, p0, Lcom/google/android/gms/analytics/s;->tg:Lcom/google/android/gms/analytics/i;

    invoke-interface {v1}, Lcom/google/android/gms/analytics/i;->currentTimeMillis()J

    move-result-wide v1

    iput-wide v1, p0, Lcom/google/android/gms/analytics/s;->sT:J
...
.method public bR()V
    ...
    invoke-interface {v0, v1, v2}, Lcom/google/android/gms/analytics/d;->j(J)V

    iput-boolean v3, p0, Lcom/google/android/gms/analytics/s;->td:Z
